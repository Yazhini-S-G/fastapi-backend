...
DATABASE_SESSION_NOT_INITIALIZED = "DatabaseSessionManager is not initialized"


class DatabaseSessionError(RuntimeError):
    """Raised when the database session manager is not initialized."""


def get_engine(host: str, **engine_kwargs: object) -> AsyncEngine:
...
class DatabaseSessionManager:
    ...
    async def close(self) -> None:
        if self.engine is None:
            msg = DATABASE_SESSION_NOT_INITIALIZED
            raise DatabaseSessionError(msg)
